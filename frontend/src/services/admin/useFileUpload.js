...
export function useFileUpload () {
  ...
  const uploadUsersXLSX = async file => {
    ...
    try {
      ...
      if (error.response) {
        ...
        console.error('No se recibió respuesta del servidor de usuarios:', error.request)
  ...
  const uploadGradesXLSX = async file => {
    ...
    try {
      ...
      if (error.response) {
        // Error de respuesta del servidor
        console.error('Respuesta de error del servidor de notas:', error.response.data)
        console.error('Estado:', error.response.status)
  ...
  return {
    // Expone las funciones para subir archivos de usuarios y notas
    uploadUsersXLSX,
    uploadGradesXLSX,
  }
}
